...
def build_spike_3d_raster_with_2d_controls(curr_spikes_df):
    ...
    spike_raster_plt_2d = Spike2DRaster(curr_spikes_df, window_duration=15.0, window_start_time=30.0, neuron_colors=None, parent=None) # setting , parent=spike_raster_plt_3d makes a single window
    ...
    spike_raster_plt_2d.update_scroll_window_region(30.0, 30.0+15.0, block_signals=False)
