...
class Render2DEventRectanglesMixin:
    ...
    ## MAIN METHOD
    ##################################################
    def add_event_rectangles(self, active_burst_intervals, active_2d_plot):
        """ 
        Inputs:
            active_2d_plot: e.g. spike_raster_window.spike_raster_plt_2d
        Usage:
            output_display_items = add_event_rectangles(spike_raster_window.spike_raster_plt_2d)
        ...
        filtered_burst_intervals = Render2DEventRectanglesMixin._post_process_detected_burst_interval_dict(active_burst_intervals, 
        ...
        data = Render2DEventRectanglesMixin.build_interval_rects_data(filtered_burst_intervals, included_burst_levels=[1,2,3,4]) # all order bursts
