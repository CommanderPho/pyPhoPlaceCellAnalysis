...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayout_Size.addItem(spacerItem1)
        self.label_4 = QtWidgets.QLabel(Form)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_Size.addWidget(self.label_4)
        self.btnColorButton = ColorButton(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btnColorButton.sizePolicy().hasHeightForWidth())
        self.btnColorButton.setSizePolicy(sizePolicy)
        ...
        self.horizontalLayout_Size.addWidget(self.btnColorButton)
