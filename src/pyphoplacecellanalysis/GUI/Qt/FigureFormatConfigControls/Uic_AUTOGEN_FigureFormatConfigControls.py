...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.page_figExport.setGeometry(QtCore.QRect(0, 0, 411, 46))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.widget = QtWidgets.QWidget(self.page_figExport)
        self.widget.setGeometry(QtCore.QRect(1, 2, 411, 51))
        self.widget.setObjectName("widget")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.widget)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.filepkr_FigureOutputPath = InlineFilesystemPathSelectWidget(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.filepkr_ProgrammaticDisplayFcnOutputPath = InlineFilesystemPathSelectWidget(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.page_debugging.setGeometry(QtCore.QRect(0, 0, 411, 46))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayoutWidget = QtWidgets.QWidget(self.page_debugging)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 0, 401, 131))
        ...
        self.lineEdit = FilesystemPathLineEdit(self.gridLayoutWidget)
