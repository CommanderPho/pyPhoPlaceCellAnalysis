...
class Ui_LocalMenus_AddRenderable(object):
    def setupUi(self, LocalMenus_AddRenderable):
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/Render/Icons/actions/chart--minus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionClear_all_Time_Curves.setIcon(icon4)
        ...
        self.actionClear_all_Time_Intervals.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/Render/Icons/actions/bar-chart_2@1x.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionTimeSynchronizedOccupancyPlotter.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/Render/Icons/actions/wifi-channel_2@1x.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionTimeSynchronizedPlacefieldsPlotter.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/Render/Icons/actions/area-chart_2@1x.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionTimeSynchronizedDecoderPlotter.setIcon(icon7)
        ...
        self.actionClear_all_Matplotlib_Plots.setIcon(icon4)
