...
class Ui_LocalMenus_AddRenderable(object):
    def setupUi(self, LocalMenus_AddRenderable):
        ...
        self.menuAdd_Matplotlib_Plot = QtWidgets.QMenu(self.menuAdd_Renderable)
        self.menuAdd_Matplotlib_Plot.setObjectName("menuAdd_Matplotlib_Plot")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/Render/Icons/actions/bar-chart_2@1x.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionTimeSynchronizedOccupancyPlotter.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/Render/Icons/actions/wifi-channel_2@1x.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionTimeSynchronizedPlacefieldsPlotter.setIcon(icon4)
        ...
        self.menuAdd_Matplotlib_Plot.addAction(self.actionAddMatplotlibPlot_DecodedPosition)
        self.menuAdd_Matplotlib_Plot.addSeparator()
        self.menuAdd_Matplotlib_Plot.addAction(self.actionClear_all_Matplotlib_Plots)
        ...
        self.menuAdd_Renderable.addAction(self.menuAdd_Matplotlib_Plot.menuAction())
    ...
    def retranslateUi(self, LocalMenus_AddRenderable):
        ...
        self.menuAdd_Matplotlib_Plot.setTitle(_translate("LocalMenus_AddRenderable", "Add Matplotlib Plot..."))
