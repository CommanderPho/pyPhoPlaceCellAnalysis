...
# Form implementation generated from reading ui file 'c:\Users\pho\repos\pyPhoPlaceCellAnalysis\src\pyphoplacecellanalysis\GUI\Qt\MainApplicationWindows\PhoPipelineMainWindow\ProgrammaticPipelineWindow\ProgrammaticPipelineWindow.ui'
#
...
class Ui_ProgrammaticPipelineWindow(object):
    def setupUi(self, ProgrammaticPipelineWindow):
        ProgrammaticPipelineWindow.setObjectName("ProgrammaticPipelineWindow")
        ProgrammaticPipelineWindow.resize(804, 791)
        ProgrammaticPipelineWindow.setWindowTitle("ProgrammaticPipelineWindow")
        ProgrammaticPipelineWindow.setIconSize(QtCore.QSize(32, 32))
        ProgrammaticPipelineWindow.setDockNestingEnabled(True)
        self.centralwidget = QtWidgets.QWidget(ProgrammaticPipelineWindow)
        self.centralwidget.setObjectName("centralwidget")
        ProgrammaticPipelineWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ProgrammaticPipelineWindow)
        ...
        ProgrammaticPipelineWindow.setMenuBar(self.menubar)
        self.actionAddTimeCurves_Position = QtWidgets.QAction(ProgrammaticPipelineWindow)
        ...
        self.actionAddTimeCurves_Custom = QtWidgets.QAction(ProgrammaticPipelineWindow)
        ...
        self.actionAddCustomRenderable = QtWidgets.QAction(ProgrammaticPipelineWindow)
        ...
        self.actionAddTimeIntervals_PBEs = QtWidgets.QAction(ProgrammaticPipelineWindow)
        self.actionAddTimeIntervals_PBEs.setText("PBEs")
        self.actionAddTimeIntervals_PBEs.setObjectName("actionAddTimeIntervals_PBEs")
        self.actionAddTimeIntervals_Session_Epochs = QtWidgets.QAction(ProgrammaticPipelineWindow)
        ...
        self.actionAddTimeIntervals_Laps = QtWidgets.QAction(ProgrammaticPipelineWindow)
        self.actionAddTimeIntervals_Laps.setText("Laps")
        self.actionAddTimeIntervals_Laps.setObjectName("actionAddTimeIntervals_Laps")
        self.actionAddTimeIntervals_Custom = QtWidgets.QAction(ProgrammaticPipelineWindow)
        ...
        self.actionAddTimeCurves_Random = QtWidgets.QAction(ProgrammaticPipelineWindow)
        self.actionAddTimeCurves_Random.setText("Random")
        self.actionAddTimeCurves_Random.setObjectName("actionAddTimeCurves_Random")
        self.actionClear_all_Time_Curves = QtWidgets.QAction(ProgrammaticPipelineWindow)
        icon5 = QtGui.QIcon()
        ...
        self.actionClear_all_Time_Intervals = QtWidgets.QAction(ProgrammaticPipelineWindow)
        ...
        self.actionClear_all_Renderables = QtWidgets.QAction(ProgrammaticPipelineWindow)
        self.actionClear_all_Renderables.setObjectName("actionClear_all_Renderables")
        self.actionAddTimeIntervals_Ripples = QtWidgets.QAction(ProgrammaticPipelineWindow)
        self.actionAddTimeIntervals_Ripples.setObjectName("actionAddTimeIntervals_Ripples")
        self.actionAddTimeIntervals_Replays = QtWidgets.QAction(ProgrammaticPipelineWindow)
        self.actionAddTimeIntervals_Replays.setObjectName("actionAddTimeIntervals_Replays")
        self.actionCreate_paired_time_synchronized_widget = QtWidgets.QAction(ProgrammaticPipelineWindow)
        self.actionCreate_paired_time_synchronized_widget.setObjectName("actionCreate_paired_time_synchronized_widget")
        self.actionTimeSynchronizedOccupancyPlotter = QtWidgets.QAction(ProgrammaticPipelineWindow)
        icon6 = QtGui.QIcon()
        ...
        self.actionTimeSynchronizedPlacefieldsPlotter = QtWidgets.QAction(ProgrammaticPipelineWindow)
        icon7 = QtGui.QIcon()
        ...
        self.actionCombineTimeSynchronizedPlotterWindow = QtWidgets.QAction(ProgrammaticPipelineWindow)
        ...
        self.actionTimeSynchronizedDecoderPlotter = QtWidgets.QAction(ProgrammaticPipelineWindow)
        icon8 = QtGui.QIcon()
        ...
        self.actionAddMatplotlibPlot_DecodedPosition = QtWidgets.QAction(ProgrammaticPipelineWindow)
        ...
        self.actionClear_all_Matplotlib_Plots = QtWidgets.QAction(ProgrammaticPipelineWindow)
        ...
        self.actionAddMatplotlibPlot_Custom = QtWidgets.QAction(ProgrammaticPipelineWindow)
        ...
        self.actionMatplotlib_View = QtWidgets.QAction(ProgrammaticPipelineWindow)
        self.actionMatplotlib_View.setObjectName("actionMatplotlib_View")
        self.actionCustom = QtWidgets.QAction(ProgrammaticPipelineWindow)
        self.actionCustom.setObjectName("actionCustom")
        self.actionTest = QtWidgets.QAction(ProgrammaticPipelineWindow)
        self.actionTest.setObjectName("actionTest")
        self.actionContext_Nested_Docks = QtWidgets.QAction(ProgrammaticPipelineWindow)
        self.actionContext_Nested_Docks.setObjectName("actionContext_Nested_Docks")
        self.actionDecoded_Epoch_Slices_Laps = QtWidgets.QAction(ProgrammaticPipelineWindow)
        ...
        self.actionDecoded_Epoch_Slices_PBEs = QtWidgets.QAction(ProgrammaticPipelineWindow)
        self.actionDecoded_Epoch_Slices_PBEs.setObjectName("actionDecoded_Epoch_Slices_PBEs")
        self.actionDecoded_Epoch_Slices_Ripple = QtWidgets.QAction(ProgrammaticPipelineWindow)
        self.actionDecoded_Epoch_Slices_Ripple.setObjectName("actionDecoded_Epoch_Slices_Ripple")
        self.actionDecoded_Epoch_Slices_Replay = QtWidgets.QAction(ProgrammaticPipelineWindow)
        self.actionDecoded_Epoch_Slices_Replay.setObjectName("actionDecoded_Epoch_Slices_Replay")
        self.actionDecoded_Epoch_Slices_Custom = QtWidgets.QAction(ProgrammaticPipelineWindow)
        ...
        self.retranslateUi(ProgrammaticPipelineWindow)
        QtCore.QMetaObject.connectSlotsByName(ProgrammaticPipelineWindow)

    def retranslateUi(self, ProgrammaticPipelineWindow):
        _translate = QtCore.QCoreApplication.translate
        self.menuAddRenderable_Matplotlib_Plot.setTitle(_translate("ProgrammaticPipelineWindow", "Add Matplotlib Plot..."))
        self.menuDocked_Widgets.setTitle(_translate("ProgrammaticPipelineWindow", "Docked Widgets"))
        self.menuAdd_Docked_Widget.setTitle(_translate("ProgrammaticPipelineWindow", "Add Docked Widget"))
        self.menuDecoder.setTitle(_translate("ProgrammaticPipelineWindow", "Decoder"))
        self.menuDecoded_Epoch_Slices.setTitle(_translate("ProgrammaticPipelineWindow", "Decoded Epoch Slices"))
        self.actionClear_all_Time_Curves.setText(_translate("ProgrammaticPipelineWindow", "Clear all Time Curves"))
        self.actionClear_all_Time_Intervals.setText(_translate("ProgrammaticPipelineWindow", "Clear all Time Intervals"))
        self.actionClear_all_Renderables.setText(_translate("ProgrammaticPipelineWindow", "Clear all Renderables"))
        self.actionAddTimeIntervals_Ripples.setText(_translate("ProgrammaticPipelineWindow", "Ripples"))
        self.actionAddTimeIntervals_Replays.setText(_translate("ProgrammaticPipelineWindow", "Replays"))
        self.actionCreate_paired_time_synchronized_widget.setText(_translate("ProgrammaticPipelineWindow", "Create paired time synchronized widget"))
        self.actionAddMatplotlibPlot_DecodedPosition.setText(_translate("ProgrammaticPipelineWindow", "Add Position Decoding"))
        self.actionAddMatplotlibPlot_DecodedPosition.setStatusTip(_translate("ProgrammaticPipelineWindow", "Use from \"Create Connected Widget\" menu"))
        self.actionClear_all_Matplotlib_Plots.setText(_translate("ProgrammaticPipelineWindow", "Clear all Matplotlib Plots"))
        self.actionAddMatplotlibPlot_Custom.setText(_translate("ProgrammaticPipelineWindow", "Custom Matplotlib Plot..."))
        self.actionMatplotlib_View.setText(_translate("ProgrammaticPipelineWindow", "Matplotlib View"))
        self.actionMatplotlib_View.setToolTip(_translate("ProgrammaticPipelineWindow", "<html><head/><body><p>Matplotlib View<img src=\":/Graphics/Icons/graphics/ic_timeline_48px.png\"/></p></body></html>"))
        self.actionCustom.setText(_translate("ProgrammaticPipelineWindow", "Custom..."))
        self.actionTest.setText(_translate("ProgrammaticPipelineWindow", "Test"))
        self.actionContext_Nested_Docks.setText(_translate("ProgrammaticPipelineWindow", "Context Nested Docks"))
        self.actionDecoded_Epoch_Slices_Laps.setText(_translate("ProgrammaticPipelineWindow", "Laps"))
        self.actionDecoded_Epoch_Slices_PBEs.setText(_translate("ProgrammaticPipelineWindow", "PBEs"))
        self.actionDecoded_Epoch_Slices_Ripple.setText(_translate("ProgrammaticPipelineWindow", "Ripple"))
        self.actionDecoded_Epoch_Slices_Replay.setText(_translate("ProgrammaticPipelineWindow", "Replay"))
        self.actionDecoded_Epoch_Slices_Custom.setText(_translate("ProgrammaticPipelineWindow", "Custom..."))
