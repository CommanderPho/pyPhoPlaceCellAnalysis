...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/Icons/Icons/TuningMapDataExplorerIconWithLabel.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.Visualization.setGeometry(QtCore.QRect(0, 0, 449, 69))
        self.Visualization.setObjectName("Visualization")
        self.VisualizationsGroup_2 = QtWidgets.QGroupBox(self.Visualization)
        self.VisualizationsGroup_2.setGeometry(QtCore.QRect(0, 0, 455, 72))
        self.VisualizationsGroup_2.setObjectName("VisualizationsGroup_2")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.VisualizationsGroup_2)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.toolButton_8 = QtWidgets.QToolButton(self.VisualizationsGroup_2)
        self.toolButton_8.setIcon(icon4)
        self.toolButton_8.setIconSize(QtCore.QSize(30, 30))
        self.toolButton_8.setObjectName("toolButton_8")
        self.gridLayout_3.addWidget(self.toolButton_8, 0, 3, 1, 1)
        self.toolButton_5 = QtWidgets.QToolButton(self.VisualizationsGroup_2)
        ...
        self.toolButton_6 = QtWidgets.QToolButton(self.VisualizationsGroup_2)
        ...
        self.toolButton_7 = QtWidgets.QToolButton(self.VisualizationsGroup_2)
        self.toolButton_7.setIcon(icon3)
        self.toolButton_7.setIconSize(QtCore.QSize(30, 30))
        self.toolButton_7.setObjectName("toolButton_7")
        self.gridLayout_3.addWidget(self.toolButton_7, 0, 4, 1, 1)
        self.toolButton_9 = QtWidgets.QToolButton(self.VisualizationsGroup_2)
        icon5 = QtGui.QIcon()
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/Render/Icons/actions/categories.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolBox.addItem(self.Visualization, icon6, "")
        self.utilities = QtWidgets.QWidget()
        self.utilities.setGeometry(QtCore.QRect(0, 0, 449, 69))
        self.utilities.setObjectName("utilities")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/Graphics/Icons/graphics/Pho Symbol.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolBox.addItem(self.utilities, icon7, "")
...
"background-color: rgb(255, 250, 242);")
        ...
        self.actionNew_Tuning_Curves_Explorer_ipcDataExplorer.setIcon(icon4)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/Graphics/Icons/graphics/Spikes.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNew_1D_Ratemaps_Plot.setIcon(icon8)
    ...
    def retranslateUi(self, Form):
        ...
        self.VisualizationsGroup_2.setTitle(_translate("Form", "Visualizations"))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.Visualization), _translate("Form", "Visualizations"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.utilities), _translate("Form", "Utilities"))
