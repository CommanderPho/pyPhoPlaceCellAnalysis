...
"background-color: rgb(255, 250, 242);")
        ...
        self.tooltab_Visualization.setGeometry(QtCore.QRect(0, 0, 511, 72))
        ...
        self.pushButton = QtWidgets.QPushButton(self.tooltab_Display)
        self.pushButton.setObjectName("pushButton")
        self.tooltab_ProgrammaticDisplayLayout.addWidget(self.pushButton)
        self.tooltab_Display_Layout.addLayout(self.tooltab_ProgrammaticDisplayLayout)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/Render/Icons/actions/category-item.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolBox.addItem(self.tooltab_Display, icon11, "")
        self.tooltab_Utilities = QtWidgets.QWidget()
        self.tooltab_Utilities.setGeometry(QtCore.QRect(0, 0, 511, 72))
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/Graphics/Icons/graphics/Pho Symbol.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.toolBox.addItem(self.tooltab_Utilities, icon12, "")
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/Graphics/Icons/graphics/Spikes.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNew_1D_Ratemaps_Plot.setIcon(icon13)
