...
"")
        ...
        self.btnJumpToPrevious.setEnabled(False)
        ...
        self.btnCurrentIntervals_Extra = QtWidgets.QToolButton(self.frame)
        self.btnCurrentIntervals_Extra.setPopupMode(QtWidgets.QToolButton.MenuButtonPopup)
        self.btnCurrentIntervals_Extra.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        self.btnCurrentIntervals_Extra.setObjectName("btnCurrentIntervals_Extra")
        self.horizontalLayout.addWidget(self.btnCurrentIntervals_Extra)
        self.btnCurrentIntervals_Remove = QtWidgets.QPushButton(self.frame)
        self.btnCurrentIntervals_Remove.setEnabled(False)
        self.btnCurrentIntervals_Remove.setObjectName("btnCurrentIntervals_Remove")
        self.horizontalLayout.addWidget(self.btnCurrentIntervals_Remove)
        self.btnCurrentIntervals_Customize = QtWidgets.QPushButton(self.frame)
        self.btnCurrentIntervals_Customize.setEnabled(False)
        self.btnCurrentIntervals_Customize.setObjectName("btnCurrentIntervals_Customize")
        self.horizontalLayout.addWidget(self.btnCurrentIntervals_Customize)
        self.btnJumpToNext = QtWidgets.QToolButton(self.frame)
        self.btnJumpToNext.setEnabled(False)
...
"")
    ...
    def retranslateUi(self, RootWidget):
        ...
        self.btnCurrentIntervals_Extra.setText(_translate("RootWidget", "Extras"))
        self.btnCurrentIntervals_Remove.setText(_translate("RootWidget", "Remove"))
        self.btnCurrentIntervals_Customize.setText(_translate("RootWidget", "Customize"))
