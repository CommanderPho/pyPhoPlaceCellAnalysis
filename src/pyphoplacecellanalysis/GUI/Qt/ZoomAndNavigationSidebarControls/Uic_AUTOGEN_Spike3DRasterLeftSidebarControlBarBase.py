...
class Ui_leftSideToolbarWidget(object):
    def setupUi(self, leftSideToolbarWidget):
        ...
        leftSideToolbarWidget.resize(121, 840)
...
"border-color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, leftSideToolbarWidget):
        ...
        self.spinAnimationTimeStep.setSuffix(_translate("leftSideToolbarWidget", "Sec"))
        self.label_5.setText(_translate("leftSideToolbarWidget", "temporal_zoom_factor"))
