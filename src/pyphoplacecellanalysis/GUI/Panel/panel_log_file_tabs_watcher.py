...
class LogFilePanel(param.Parameterized):
    """ 
    from pyphoplacecellanalysis.GUI.Panel.panel_log_file_tabs_watcher import LogFilePanel
    ...
    class LogFileTab(param.Parameterized):
        ...
        def __init__(self, file_path, **params):
            ...
            self.terminal = pn.widgets.Terminal(name=file_path, height=400, sizing_mode='stretch_both') # , sizing_mode='stretch_width'
