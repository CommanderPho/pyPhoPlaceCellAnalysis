...
examples_ = OrderedDict([
    ...
    ('Crosshair / Mouse interaction', 'crosshair_example.py'),
    ('Binned Image Rendering', 'BinnedImageRenderingWindow.py'),
    ...
    ('Dock Planning Helper', 'DockPlanningHelperWidget.py'),
    ('Dock Planning Helper Window', 'DockPlanningHelperWindow.py'),
    ...
    ('GraphicsItems', OrderedDict([
        ...
        ('Interval Rects', 'IntervalRectsItem.py'),
    ])),
    ...
    ('Widgets', OrderedDict([
        ...
        ('Epochs Editor', 'EpochsEditorItem.py'),
        ('Parameter Tree Widget', 'ParameterTreeWidget.py'),
    ])),
