            ...
            for s in strings:
                if s is None:
                    ...
                    if not isinstance(s, str):
                        s = str(s)
                    br = p.boundingRect(QtCore.QRectF(0, 0, 100, 100), QtCore.Qt.AlignmentFlag.AlignCenter, s) # appears to occur when setting ticks to numeric values, doesn't auto-convert them to strings
