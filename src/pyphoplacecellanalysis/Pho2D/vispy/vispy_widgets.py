...
class CanvasEventHandlerMixin: # Canvas(app.Canvas):
    """ Implementors respond to app.Canvas events
    SceneCanvas
    
    from pyphoplacecellanalysis.Pho2D.vispy.vispy_widgets import CanvasEventHandlerMixin
...
# class CustomCanvas(CanvasEventHandlerMixin, app.Canvas):
#     """ Implementors respond to app.Canvas events
#     SceneCanvas
#     """
#     def __init__(self, *args, **kwargs):
#         app.Canvas.__init__(self, *args, **kwargs)
#         self.title = 'CustomCanvas'
