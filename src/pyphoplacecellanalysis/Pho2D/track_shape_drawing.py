...
class LinearTrackDimensions:
    ...
    def _build_component_rectangles(self):
        ...
        if self.alignment_axis == 'x':
            ...
            rects = [
                (0, 0, major_axis_factor * self.platform_side_length, major_axis_factor * self.platform_side_length),
                (major_axis_factor * self.platform_side_length, track_origin_y, major_axis_factor * self.track_length, minor_axis_factor * self.track_width),
                (major_axis_factor * (self.platform_side_length + self.track_length), 0, major_axis_factor * self.platform_side_length, major_axis_factor * self.platform_side_length)
            ]
            ...
            rects = [
                (0, 0, major_axis_factor * self.platform_side_length, major_axis_factor * self.platform_side_length),
                (track_origin_x, major_axis_factor * self.platform_side_length, minor_axis_factor * self.track_width, major_axis_factor * self.track_length),
                (0, major_axis_factor * (self.platform_side_length + self.track_length), major_axis_factor * self.platform_side_length, major_axis_factor * self.platform_side_length)
            ]
        else:
