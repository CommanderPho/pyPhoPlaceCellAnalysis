...
def _get_custom_filenames_from_computation_metadata(epochs_source: str='normal_computed', minimum_inclusion_fr_Hz=None, included_qclu_values=None) -> Dict[str, str]:
...
def save_custom_parameters_pipeline(a_curr_active_pipeline, epochs_source: str='normal_computed', minimum_inclusion_fr_Hz=None, included_qclu_values=None, enable_save_pipeline_pkl: bool=True, enable_save_global_computations_pkl: bool=False, enable_save_h5: bool = False, saving_mode=PipelineSavingScheme.TEMP_THEN_OVERWRITE):
