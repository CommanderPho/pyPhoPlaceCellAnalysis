...
class DefaultComputationFunctions(AllFunctionEnumeratingMixin, metaclass=ComputationFunctionRegistryHolder):
    ...
    #     # new_1D_decoder = BayesianPlacemapPositionDecoder(placefield_computation_config.time_bin_size, new_decoder_pf1D, new_1D_decoder_spikes_df, manual_time_window_edges=manual_time_window_edges, manual_time_window_edges_binning_info=manual_time_window_edges_binning_info, debug_print=False)
    ...
    #     new_2D_decoder = BayesianPlacemapPositionDecoder(placefield_computation_config.time_bin_size, new_decoder_pf2D, new_decoder_spikes_df, manual_time_window_edges=manual_time_window_edges, manual_time_window_edges_binning_info=manual_time_window_edges_binning_info, debug_print=False)
    #     new_2D_decoder.compute_all()
        
    #     # Add the 'pf2D_Decoder' property
    #     computation_result.computed_data['pf2D_Decoder'] = new_2D_decoder
    ...
    #     # active_epoch_decoder_result = active_decoder.decode_specific_epochs(sess.spikes_df, filter_epochs=active_epoch, decoding_time_bin_size=placefield_computation_config.time_bin_size, debug_print=False)
    ...
    #     time_bin_edges, p_x_given_n, most_likely_positions, curr_unit_marginal_x = active_decoder.hyper_perform_decode(sess.spikes_df, decoding_time_bin_size=placefield_computation_config.time_bin_size, debug_print=False)
        
        
    #     ## TODO: NEXT: Add to computation result
    #     # Add the 'pf2D_Decoder' property
    #     computation_result.computed_data['pf2D_Decoder'] = new_2D_decoder
