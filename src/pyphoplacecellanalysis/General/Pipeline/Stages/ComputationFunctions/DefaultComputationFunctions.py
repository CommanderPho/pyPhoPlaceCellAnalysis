...
class DefaultComputationFunctions(AllFunctionEnumeratingMixin, metaclass=ComputationFunctionRegistryHolder):
    ...
    @function_attributes(short_name='_perform_specific_epochs_decoding', tags=['BasePositionDecoder', 'computation', 'decoder', 'epoch'],
                          ...
                          uses=['_subfn_compute_decoded_epochs'], used_by=[], creation_date='2023-04-07 02:16',
...
@function_attributes(short_name='_subfn_compute_decoded_epochs', tags=['BasePositionDecoder'], input_requires=[], output_provides=[], uses=['KnownFilterEpochs.process_functionList'], used_by=['_perform_specific_epochs_decoding'], creation_date='2023-04-07 02:15')
