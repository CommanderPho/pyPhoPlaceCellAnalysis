...
class EloyAnalysisDisplayFunctions(AllFunctionEnumeratingMixin, metaclass=DisplayFunctionRegistryHolder):
    ...
    def _display_pf_peak_prominence2d_default_quadrant_plots(computation_result, active_config, enable_saving_to_disk=False, debug_print=False, **kwargs):
            ...
            def _plot_prominence_peaks(xx, yy, out_results, debug_print=False):
                """ Plots the 4-quadrant figure generated by default from peak_rpominence2d to show the found prominence peaks
                ...
                for curr_neuron_id, a_result in out_results.items():
                    ...
                    try:
                        figure, (ax1, ax2, ax3, ax4) = plot_Prominence(xx, yy, a_result['slab'], a_result['peaks'], a_result['id_map'], a_result['prominence_map'], a_result['parent_map'], debug_print=debug_print)
            ...
            out_figs, out_axes, out_idxs = _plot_prominence_peaks(active_peak_prominence_2d_results.xx, active_peak_prominence_2d_results.yy, active_peak_prominence_2d_results.results, debug_print=debug_print)
            return out_figs, out_axes, out_idxs
    ...
    def _display_pf_peak_prominence2d_plots(computation_result, active_config, enable_saving_to_disk=False, debug_print=False, **kwargs):
            ...
            figure, ax = _plot_single_neuron_result(valid_neuron_id, active_peak_prominence_2d_results.results[valid_neuron_id], promenence_plot_threshold = 1.0, included_level_indicies=[1], debug_print=debug_print)
            return figure, ax