...
def batch_load_session(global_data_root_parent_path: Path, active_data_mode_name: str, basedir: Path, active_pickle_filename:str='loadedSessPickle.pkl', force_reload=False, saving_mode=PipelineSavingScheme.SKIP_SAVING, fail_on_exception=True, skip_extended_batch_computations=False, override_parameters_flat_keypaths_dict=None,
...
# ==================================================================================================================== #
@metadata_attributes(short_name=None, tags=['plotting', 'batch', 'non-interactive'], input_requires=[], output_provides=[], uses=[], used_by=[], creation_date='2025-07-09 12:21', related_items=[])
class BatchPlotting:
    """ 

    History:
        Moved batch_programmatic_figures and batch_extended_programmatic_figures into BatchPlotting
    ...
    @classmethod
    def find_batch_programmatic_figures_output_dir(cls) -> Path:
        """ finds the figures output directory

        collected_figures_folder, fig_out_man = BatchPlotting.find_batch_programmatic_figures_output_dir()

        Updates: cls._override_output_parent_path, cls._fig_out_man
        ...
        ## Update _override_output_parent_path
        cls._override_output_parent_path = collected_figures_folder
        ...
        return collected_figures_folder, fig_out_man
    ...
    @classmethod
    def batch_programmatic_figures(cls, curr_active_pipeline, debug_print=False):
    ...
    def batch_extended_programmatic_figures(cls, curr_active_pipeline, write_vector_format=False, write_png=True, disable_unsafe_qt_calls: bool = True, debug_print=False):
        ...
        try:
            _out = curr_active_pipeline.display('_display_short_long_firing_rate_index_comparison', curr_active_pipeline.get_session_context(), defer_render=True, **_batch_figure_kwargs, save_figure=save_figure)
        except Exception as e:
            print(f'batch_extended_programmatic_figures(...): _display_short_long_firing_rate_index_comparison failed with error: {e}\n skipping.')
        
        try:
            _out = curr_active_pipeline.display('_display_long_short_expected_v_observed_firing_rate', curr_active_pipeline.get_session_context(), defer_render=True, **_batch_figure_kwargs, save_figure=save_figure)
        except Exception as e:
            print(f'batch_extended_programmatic_figures(...): _prepare_plot_expected_vs_observed failed with error: {e}\n skipping.')
        
        try:
            _out = curr_active_pipeline.display('_display_grid_bin_bounds_validation', curr_active_pipeline.get_session_context(), defer_render=True, **_batch_figure_kwargs, save_figure=save_figure)
        except Exception as e:
            print(f'batch_extended_programmatic_figures(...): _display_grid_bin_bounds_validation failed with error: {e}\n skipping.')
            
        try:
            _out = curr_active_pipeline.display('_display_running_and_replay_speeds_over_time', curr_active_pipeline.get_session_context(), defer_render=True, **_batch_figure_kwargs, save_figure=save_figure)
        except Exception as e:
            print(f'batch_extended_programmatic_figures(...): _display_running_and_replay_speeds_over_time failed with error: {e}\n skipping.')
            
        try:
            _out = curr_active_pipeline.display('_display_long_short_laps', curr_active_pipeline.get_session_context(), defer_render=True, **_batch_figure_kwargs, save_figure=save_figure) # batch_extended_programmatic_figures(...): _display_long_short_laps failed with error: plot_position_curves_figure() got an unexpected keyword argument 'active_config_name'
        except Exception as e:
            print(f'batch_extended_programmatic_figures(...): _display_long_short_laps failed with error: {e}\n skipping.')
            
        try:
            _out = curr_active_pipeline.display('_display_long_and_short_firing_rate_replays_v_laps', curr_active_pipeline.get_session_context(), defer_render=True, **_batch_figure_kwargs, save_figure=save_figure)
        except Exception as e:
        ...
        try:
            ...
            _out = curr_active_pipeline.display('_display_long_short_pf1D_comparison', curr_active_pipeline.get_session_context(), single_figure=False, debug_print=False, fignum='Short v Long pf1D Comparison',
                                    ...
                                    save_figure=save_figure, **_batch_figure_kwargs) # defer_render=True, 
        except Exception as e:
            print(f'batch_extended_programmatic_figures(...): _display_long_short_pf1D_comparison failed with error: {e}\n skipping.')

        
        try:
            _out = curr_active_pipeline.display('_display_directional_merged_pf_decoded_stacked_epoch_slices', curr_active_pipeline.get_session_context(), defer_render=True, save_figure=save_figure, **_batch_figure_kwargs, is_dark_mode=False)
        ...
        if not disable_unsafe_qt_calls:
            ...
            try:
                ...
                _out = curr_active_pipeline.display('_display_long_and_short_stacked_epoch_slices', curr_active_pipeline.get_session_context(), defer_render=False, **_batch_figure_kwargs, save_figure=save_figure)
            except Exception as e:
        ...
        try:
            _out = curr_active_pipeline.display('_display_directional_merged_pf_decoded_epochs_marginals', curr_active_pipeline.get_session_context(), defer_render=True, **_batch_figure_kwargs, save_figure=save_figure)
        except Exception as e:
        ...
        try:
            _out = curr_active_pipeline.display('_display_rank_order_z_stats_results', curr_active_pipeline.get_session_context(), defer_render=True, **_batch_figure_kwargs, save_figure=save_figure)
        except Exception as e:
            print(f'batch_extended_programmatic_figures(...): "_display_rank_order_z_stats_results" failed with error: {e}\n skipping.')


        try:
            _out = curr_active_pipeline.display('_display_directional_track_remapping_diagram', curr_active_pipeline.get_session_context(), defer_render=True, **_batch_figure_kwargs, save_figure=save_figure, is_dark_mode=False)
        except Exception as e:
            print(f'batch_extended_programmatic_figures(...): "_display_directional_track_remapping_diagram" failed with error: {e}\n skipping.')


        try:
            _out = curr_active_pipeline.display('_display_trial_to_trial_reliability', curr_active_pipeline.get_session_context(), defer_render=True, **_batch_figure_kwargs, save_figure=save_figure, is_dark_mode=False)
        except Exception as e:
        ...
        try:
            _out = curr_active_pipeline.display('_display_measured_vs_decoded_occupancy_distributions', curr_active_pipeline.get_session_context(), defer_render=True, **_batch_figure_kwargs, save_figure=save_figure, size=[18, 8], dpi=100)
        except Exception as e:
        ...
        try:
            _out = curr_active_pipeline.display('_display_generalized_decoded_yellow_blue_marginal_epochs', curr_active_pipeline.get_session_context(), defer_render=True, **_batch_figure_kwargs, save_figure=save_figure, is_dark_mode=False)
        except Exception as e:
...
class BatchPhoJonathanFiguresHelper:
    ...
    def _subfn_batch_plot_automated(cls, curr_active_pipeline, included_unit_neuron_IDs=None, active_identifying_ctx=None, fignum=None, fig_idx=0, n_max_page_rows=10, disable_top_row=False, **kwargs) -> MatplotlibRenderPlots:
        ...
        single_subfigure_size_inches = np.array([6.0,  0.6685]) # #TODO 2025-07-23 15:53: - [ ] Changed again for publication output and fitting in figure 1
    ...
    @function_attributes(short_name=None, tags=['save', 'export', 'single-figure'], input_requires=[], output_provides=[], uses=[], used_by=['cls._perform_save_batch_plotted_figures'], creation_date='2025-06-30 22:45', related_items=[])
    @classmethod
    def _perform_save_single_plotted_fig(cls, curr_active_pipeline, curr_active_identifying_ctx: IdentifyingContext, a_fig_container: MatplotlibRenderPlots, subset_includelist=None, subset_excludelist=None, write_vector_format=False, write_png=True, override_fig_man: Optional[FileOutputManager]=None, progress_print=True, debug_print=False):
        """ Saves a single figure produced by the first half of `_perform_batch_plot` 
    ...
    @function_attributes(short_name=None, tags=['save', 'export', 'multi-figure'], input_requires=[], output_provides=[], uses=['cls._perform_save_single_plotted_fig'], used_by=[], creation_date='2025-06-30 22:45', related_items=[])
    @classmethod
    def _perform_save_batch_plotted_figures(cls, curr_active_pipeline, active_out_figure_container_dict: Dict[IdentifyingContext, MatplotlibRenderPlots], subset_includelist=None, subset_excludelist=None, write_vector_format=False, write_png=True, override_fig_man: Optional[FileOutputManager]=None, progress_print=True, debug_print=False):
        ...
        for curr_active_identifying_ctx, a_fig_container in active_out_figure_container_dict.items():
            ## 2023-06-14 - New way using `fig_man.get_figure_save_file_path(...)` - this is correct
            curr_output_file_paths = cls._perform_save_single_plotted_fig(curr_active_pipeline=curr_active_pipeline, curr_active_identifying_ctx=curr_active_identifying_ctx, a_fig_container=a_fig_container,
                                                                  subset_includelist=subset_includelist, subset_excludelist=subset_excludelist,
                                                                  write_vector_format=write_vector_format, write_png=write_png, override_fig_man=fig_man,
                                                                  progress_print=progress_print, debug_print=debug_print)
            output_file_paths.extend(curr_output_file_paths)
        ## END for curr_active_identifying_ctx, a_fig_container in active_out_figure_container_dict.items()...
    ...
    def _perform_batch_plot(cls, curr_active_pipeline, active_kwarg_list, subset_includelist=None, subset_excludelist=None, write_vector_format=False, write_png=True, progress_print=True, debug_print=False, close_figures_to_save_memory: bool = True, override_fig_man: Optional[FileOutputManager]=None, **kwargs) -> Dict[IdentifyingContext, MatplotlibRenderPlots]:
        ...
        if progress_print:
            print(f'n_out_figures: {n_out_figures}')
        # Each figure:
        for i, curr_batch_plot_kwargs in enumerate(active_kwarg_list):
            if progress_print:
                print(f'generating figure {i+1}/{n_out_figures}')
            ...
            if needs_output_figures:
                ...
                output_file_paths = cls._perform_save_single_plotted_fig(curr_active_pipeline, curr_active_identifying_ctx=curr_active_identifying_ctx, a_fig_container=a_fig_container,
                                                              subset_includelist=subset_includelist, subset_excludelist=subset_excludelist,
                                                              write_vector_format=write_vector_format, write_png=write_png, override_fig_man=fig_man,
                                                             progress_print=progress_print, debug_print=debug_print)
                if progress_print:
                    print(f'\tdone.')
            if close_figures_to_save_memory:
                ## close the figure
                for a_fig in a_fig_container.figures:
                    # a_fig.close()
                    plt.close() ## have to use non-OOP version?
                    # plt.close('all')
            

        if progress_print:
            print(f'finished all {n_out_figures} figures.')
        # ## perform saving if needed:
        # if needs_output_figures:
        # 	if progress_print:
        # 		print(f'writing images...')
...
def batch_perform_all_plots(curr_active_pipeline, enable_neptune=True, neptuner=None, debug_print: bool = False):
    ...
    try:
        active_identifying_session_ctx, active_out_figures_dict = BatchPlotting.batch_programmatic_figures(curr_active_pipeline, debug_print=debug_print)
    except Exception as e:
    ...
    try:
          BatchPlotting.batch_extended_programmatic_figures(curr_active_pipeline=curr_active_pipeline, debug_print=debug_print)
    except Exception as e:
