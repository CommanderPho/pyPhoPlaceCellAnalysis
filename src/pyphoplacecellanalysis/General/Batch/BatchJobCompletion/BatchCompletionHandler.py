...
def _update_pipeline_missing_preprocessing_parameters(curr_active_pipeline, debug_print=False):
    ...
    def _subfn_update_session_missing_preprocessing_parameters(sess):
        ...
        if preprocessing_parameters is None:
            ...
            default_PBE_estimation_parameters = DynamicContainer(sigma=0.030, thresh=(0, 1.5), min_dur=0.030, merge_dur=0.100, max_dur=2.3) # 2023-10-05 Kamran's imposed Parameters, wants to remove the effect of the max_dur which was previously at 0.300
