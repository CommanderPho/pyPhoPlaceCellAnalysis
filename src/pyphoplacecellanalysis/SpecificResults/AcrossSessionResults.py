...
if TYPE_CHECKING:
    ...
    ## TYPEHINTING ONLY:
    from pyphoplacecellanalysis.General.Pipeline.Stages.ComputationFunctions.MultiContextComputationFunctions.DirectionalPlacefieldGlobalComputationFunctions import TrackTemplates, DirectionalLapsResult
...
# ================================================================================================================================================================================ #
# Extracted from `DecoderDecodedEpochsResult` 2025-03-12 where it was used to help with exporting marginal posterior .CSVs                                                         #
# ================================================================================================================================================================================ #
...
class DecodedResultExportingMixin:
    """ """
    @classmethod
