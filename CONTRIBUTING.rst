...
Welcome to ``pyPhoPlaceCellAnalysis`` contributor's guide.
...
If you experience bugs or general issues with ``pyPhoPlaceCellAnalysis``, please have a look
...
You can help improve ``pyPhoPlaceCellAnalysis`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``pyPhoPlaceCellAnalysis`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``pyPhoPlaceCellAnalysis``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n pyPhoPlaceCellAnalysis python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/pyPhoPlaceCellAnalysis.git
...
#. Install |pre-commit|_::
   ...
   ``pyPhoPlaceCellAnalysis`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/pyPhoPlaceCellAnalysis
.. _issue tracker: https://github.com/<USERNAME>/pyPhoPlaceCellAnalysis/issues
.. <-- end -->
